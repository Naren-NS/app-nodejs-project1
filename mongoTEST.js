...
function insertPersonalDetails(data){
  try{
    const clxn=client.db("student_database").collection("student_registration");
    const result = clxn.insertOne(data);
    console.log(result);
  }
  catch(e){
    console.log(e);
...
module.exports = { insertDocument,insertPersonalDetails }
